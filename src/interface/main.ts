...
export default function renderSvelte(
  Component: SvelteComponent | any, // Component to be rendered (Svelte component or any)
  mountPoint: ShadowRoot | HTMLElement, // Element or Shadow DOM root where the component will be mounted
