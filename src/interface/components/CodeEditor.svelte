<script lang="ts">
  ...
  function createEditorState(initialContents: string) {
      let extensions = [
          highlightSpecialChars(),          // Highlights special characters
          history(),                        // Enables undo/redo history
          drawSelection(),                  // Enables text selection drawing
          indentUnit.of("  "),              // Defines the indentation unit as two spaces
          EditorState.allowMultipleSelections.of(true), // Allows multiple selections
          indentOnInput(),                  // Automatically indents after input
          bracketMatching(),                // Enables bracket matching
          closeBrackets(),                  // Automatically closes brackets
          autocompletion(),                 // Enables code autocompletion
          rectangularSelection(),           // Enables rectangular selection
          crosshairCursor(),                // Displays a crosshair cursor
          dropCursor(),                     // Enables a cursor when dragging
          highlightActiveLine(),            // Highlights the active line
          highlightSelectionMatches(),      // Highlights matching selections
          editorTheme.of(githubLight),      // Applies the light theme by default
          keymap.of([                        // Sets up keymap for various editor commands
              indentWithTab,
              ...closeBracketsKeymap,
              ...defaultKeymap,
              ...historyKeymap,
