import renderSvelte from "@/interface/main"; // Function to render Svelte components
import themeCreator from "@/interface/pages/themeCreator.svelte"; // Svelte component for theme creation UI
import { unmount } from "svelte"; // Function to unmount Svelte components
import { ThemeManager } from "@/plugins/built-in/themes/theme-manager"; // Singleton class for managing themes
import { settingsState } from "@/seqta/utils/listeners/SettingsState"; // Reactive state for user settings

let themeCreatorSvelteApp: any = null; // Store the rendered Svelte app instance
const themeManager = ThemeManager.getInstance(); // Get the singleton instance of ThemeManager
