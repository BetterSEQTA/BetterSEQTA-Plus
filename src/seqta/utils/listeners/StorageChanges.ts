...
import { settingsState } from "./SettingsState"; // Import settingsState to handle app settings
import { updateAllColors } from "@/seqta/ui/colors/Manager"; // Function to update color settings

import { addShortcuts } from "@/seqta/utils/Adders/AddShortcuts"; // Function to add new shortcuts
import { CreateCustomShortcutDiv } from "@/seqta/utils/CreateEnable/CreateCustomShortcutDiv"; // Function to create custom shortcut div
import { FilterUpcomingAssessments } from "@/seqta/utils/FilterUpcomingAssessments"; // Function to filter upcoming assessments
import { RemoveShortcutDiv } from "@/seqta/utils/DisableRemove/RemoveShortcutDiv"; // Function to remove shortcut div
...
export class StorageChangeHandler {
  ...
  private registerHandlers() {
    settingsState.register("selectedColor", updateAllColors.bind(this)); // Register color change handler
    settingsState.register("DarkMode", this.handleDarkModeChange.bind(this)); // Register dark mode change handler
    settingsState.register("onoff", this.handleOnOffChange.bind(this)); // Register on/off toggle handler
    settingsState.register("shortcuts", this.handleShortcutsChange.bind(this)); // Register shortcuts change handler
