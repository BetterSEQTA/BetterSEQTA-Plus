...
// Create a manifest for the Chrome browser extension, merging base manifest with version and description from package.json
export const chrome = createManifest(
  ...
  "chrome", // Specify "chrome" as the target platform
);
